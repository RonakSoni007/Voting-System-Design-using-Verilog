...
HD_PWD='C:/Users/ronak/Voting Machine/Voting Machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log votingMachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source votingMachine.tcl
