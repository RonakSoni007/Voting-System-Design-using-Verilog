...
HD_PWD='C:/Users/ronak/Voting Machine/Voting Machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log votingMachine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source votingMachine.tcl -notrace
